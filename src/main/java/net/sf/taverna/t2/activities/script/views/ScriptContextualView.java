...
/**
 * A simple non editable HTML table view over a {@link ScriptActivity}.
 * Clicking on the configure button shows the editable
 * {@link ScriptConfigView}
 * 
 * @author Ian Dunlop
 * @author Stuart Owen
 * 
...
public class ScriptContextualView extends
		HTMLBasedActivityContextualView<ScriptActivityConfigurationBean> {

	public ScriptContextualView(Activity<?> activity) {
		super(activity);
		init();
	}
...
//					+ "</td>"
	...
	public Action getConfigureAction(Frame owner) {
		return new ScriptActivityConfigurationAction(
				(ScriptActivity) getActivity(), owner);
	}
