...
public class AddScriptTemplateAction extends AbstractContextualMenuAction {
	...
	private static Logger logger = Logger
			.getLogger(AddScriptTemplateAction.class);

	public AddScriptTemplateAction() {
	...
	protected class AddScriptAction extends AbstractAction {
		AddScriptAction () {
			super (ADD_SCRIPT, ActivityIconManager.getInstance().iconForActivity(
						new ScriptActivity()));
		}
